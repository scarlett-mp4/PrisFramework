...
public class GameMenuUtils {
    ...
    public static StaticPane createMenuBar(PrisBukkitPlayer player) {
        ...
        pane.addItem(new GuiItem(you, inventoryClickEvent -> new Profile().open(player)), 1, 0);
        pane.addItem(new GuiItem(you, inventoryClickEvent -> new Profile().open(player)), 2, 0);
